...
window.title("ClasificadorGeneroMusical")
window.geometry('400x400')
window.iconbitmap("./clef.ico")
window.maxsize(width=400,height=400)
frame1 = tk.Frame(window, bg='#0080FF')
...
lbl0.place(x=40,y=150)

lbl1 = tk.Label(frame1, text="UTP 2019",
                bg=bgframe,
                fg='Black',
                font=("Helvetica",8))
lbl1.place(x=166,y=365)
...
def identificar_genero():
    audiopath = choose_file() #Buscamos la cancion a identificar genero
    ...
    if(audiopath != ""):
        ...
        try:
            ...
            #Se procede a estandarizar las caraceteristicas con respecto a las medias y desviaciones estándar
            progressbar.step(9.99)  
...
def click_credits():         
    tk.messagebox.showinfo("Créditos","Hecho por :   -Juan Vicente Hoyos 1089720769\n \t     -Cristian Camilo Manzano 1088324977 \n\n          Universidad Tecnologica de Pereira\n\t\t    2019")
